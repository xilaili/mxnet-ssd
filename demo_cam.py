...
if __name__ == '__main__':
    ...
    while True:
        _, frame = vc.read()
        # process frame
        frame = detector.demo(frame, CLASSES, args.thresh, args.show_timer)
    ...
    '''
    # test
    img = cv2.imread('data/demo/dog.jpg')
    frame = detector.demo(img, CLASSES, args.thresh, args.show_timer)
